    ...
    public class DbInitializer
    {
        public static void Initialize (SchoolContext context)
        {
            ...
            var departments = new Department[]
            {
                ...
                InstructorID = instructors.Single( instructors => instructors.LastName == "Abercrombie").ID },
                new Department {Name = "Mathematics", Budget = 100000,
                StartDate = DateTime.Parse("2007-09-01"),
                InstructorID = instructors.Single( instructors => instructors.LastName == "Fakhouri").ID },
                new Department {Name = "Engineering", Budget = 350000,
                StartDate = DateTime.Parse("2007-09-01"),
                InstructorID = instructors.Single( instructors => instructors.LastName == "Harui").ID },
                new Department {Name = "Economics", Budget = 100000,
                StartDate = DateTime.Parse("2007-09-01"),
                InstructorID = instructors.Single( instructors => instructors.LastName == "Kapoor").ID },
